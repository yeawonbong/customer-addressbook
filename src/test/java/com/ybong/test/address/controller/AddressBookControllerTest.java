...
import com.ybong.test.address.exception.BizValidationException;
...
import com.ybong.test.address.exception.GlobalExceptionHandler;
...
class AddressBookControllerTest {
    ...
    void testAddCustomer() throws Exception {
        ...
        when(customerMapper.toCustomerResponse(any())).thenReturn(new com.ybong.test.address.dto.CustomerResponse(customer));
    ...
    void testSearchCustomers() throws Exception {
        ...
        when(customerMapper.toCustomerSearchResponse(any())).thenReturn(
            com.ybong.test.address.dto.CustomerSearchResponse.builder()
                .count(1)
    ...
    void testUpdateCustomer() throws Exception {
        ...
        when(customerMapper.toCustomerUpdateResponse(any())).thenReturn(
            com.ybong.test.address.dto.CustomerUpdateResponse.builder()
    ...
    void testDeleteCustomers() throws Exception {
        ...
        when(customerMapper.toCustomerDeleteResponse(any())).thenReturn(
            com.ybong.test.address.dto.CustomerDeleteResponse.builder()
                .deletedCount(2)
